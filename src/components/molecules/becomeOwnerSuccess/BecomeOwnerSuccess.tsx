...
import { resetFlow } from "@/redux/features/ownerSlice/ownerSlice";
  ...
  return (
    <div className="flex flex-col items-center gap-y-5 my-14">
      <Typography
        variant="h4"
        element="h4"
        className="text-gray-800 font-mi-sans-semi-bold text-center">
        {t("awesome_we_have_received_your_request_successfully")}
      </Typography>
      <Typography
        variant="p3"
        element="p"
        className="text-lg lg:text-2xl text-gray-800 text-center">
        {t(
